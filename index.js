...
function infowindowContent(text, latres, lngres) {
    return '<div id="info_window">' + text + '<br/><strong>' + trans.Latitude + '</strong> ' + Math.round(latres*1000000)/1000000 + ' | <strong>' + trans.Longitude + '</strong> ' + Math.round(lngres*1000000)/1000000 + '<br/><br/><span id="altitude"><button type="button" class="btn btn-primary" onclick="getElevation()">' + trans.GetAltitude + '</button></span>' + bookmark() + '</div>';
}
